...
const HeroSection = () => {
    return (
        <div className="pl-6 md:pl-0 px-2 text-black">
  ...
  <li>
    ...
    <div className="timeline-start mb-10 md:text-end">
      ...
      <div className="text-lg font-black text-blue-400">Facility</div>
  ...
  <hr className="bg-blue-400" />
    ...
    <div className="timeline-end mb-10 md:text-start">
      <time className="font-mono italic text-[#fdbb04]">Step-2</time>
      <div className="text-lg font-black text-blue-500">View Details</div>
  ...
  <hr className="bg-blue-500" />
    ...
    <div className="timeline-start mb-10 md:text-end">
      ...
      <div className="text-lg font-black text-blue-600">Book Now</div>
  ...
  <hr className="bg-blue-600" />
    ...
    <div className="timeline-end mb-10 md:text-start">
      ...
      <div className="text-lg font-black text-blue-800">Date Chose</div>
  ...
  <hr className="bg-blue-800" />
    ...
    <div className="timeline-start mb-10 md:text-end">
      ...
      <div className="text-lg font-black text-blue-800">Start and End time</div>
