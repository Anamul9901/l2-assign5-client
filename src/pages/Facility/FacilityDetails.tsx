...
const FacilityDetails = () => {
  ...
  const singleFacility = allFacility?.data?.filter(
    ...
    <div className="min-h-[100vh] max-w-7xl mx-auto w-full py-10 px-2">
      <div className="md:pt-20">
        {allFacility?.data
          ...
          .map((item: any) => (
            <div className="card lg:card-side bg-base-100 shadow-md rounded-none">
              <figure>
                <img
              ...
              <div className="card-body">
                ...
                <h1 className="text-lg">Price Per Hour: {item?.pricePerHour}$</h1>
